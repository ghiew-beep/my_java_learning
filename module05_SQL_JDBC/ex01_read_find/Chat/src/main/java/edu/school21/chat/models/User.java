...
public class User {
	...
	public String toShortString() {
		return "id=" + id + ",login=\"" + login + ",password=\"" + password + "\",createdRooms=null,rooms=null";
	}
	...
	public String toString() {
		return "User{" +
				...
				", login='" + login + '\'' +
				", password='" + password + '\'' +
				", createdRoomsCount=" + (createdRooms != null ? createdRooms.size() : null) +
				", socializedRoomsCount=" + (socializedRooms != null ? socializedRooms.size() : null) +
				'}';
	}
}